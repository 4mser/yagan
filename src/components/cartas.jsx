      ...
      >
        ...
        <SwiperSlide >
          <Link href={'/tragos'}>
            ...
            <p className='text-xs font-extralight py-2 opacity-90'>Tragos</p>
          </Link>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <Link href={'/sushi'}>
            ...
            <p className='text-xs font-extralight py-2 opacity-90'>Sushi</p>
          </Link>
        </SwiperSlide>
        ...
        <SwiperSlide >
          <Link href={'/carta'}>
            ...
            <p className='text-xs font-extralight py-2 opacity-90'>Platos</p>
          </Link>
        </SwiperSlide>
